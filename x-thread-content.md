# X Thread: Brand Asset Generator
...
i built a prompt that turns one logo into 70+ brand assets
...
most founders and indie hackers waste hours in canva making the same assets over and over

new social profile? open canva
need an OG image? back to canva
business card? canva again

i wanted to see if AI could just... do all of it at once

---

### Tweet 3

so i wrote a prompt that acts like a full branding team:
...
Take these screenshots to include in your thread:

### Screenshot 1: Folder Structure
**File:** Open the `branding-design` folder in VS Code or File Explorer
**Show:** The complete folder structure with all subfolders expanded
**Caption:** "the full output structure"
...
5. **Reply to yourself:** Post each tweet as a reply to keep the thread connected

6. **Pin tweet 1:** After posting, pin the hook tweet to your profile
...
## Engagement Replies to Prep

When people ask questions, have these ready:
